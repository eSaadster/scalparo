    ...
    def calculate_market_benchmark(self, symbol: str, start_date: str, end_date: str, 
        ...
        try:
            ...
            if benchmark_data.empty:
                print(f"No benchmark data available for {symbol}, using default results")
                return self._empty_result(initial_capital)
            ...
            print(f"Benchmark data unavailable for {symbol} (network restrictions): using sample benchmark")
            return self._empty_result(initial_capital)
